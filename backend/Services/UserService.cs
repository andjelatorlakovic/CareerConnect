...
public class UserService : IUserService
{
    ...
    public async Task AdminRemoveJobListingAsync(Guid jobId)
    {
        var job = await _context.JobListings.FirstOrDefaultAsync(j => j.Id == jobId) ?? throw new InvalidOperationException("Job listing not found.");
